...
public class A3Example
{
   public static void main(String[] args) {
      ...
      System.out.println("Learning Outcomes for math indicator for " + SE2AA4.getName() + ": ");
      System.out.println(SE2AA4.getLOs(IndicatorT.math).length);
      for (LOsT outcome : SE2AA4.getLOs(IndicatorT.math)) {
          System.out.print(outcome.getName() + " ");
      }
   //    System.out.println("nexttt");
   //    for (LOsT outcome : SE2AA4.getLOs(IndicatorT.math)) {
   //       System.out.print(Arrays.toString(outcome.measures()) + " ");
   //   }
     System.out.println();
